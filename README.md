...
> ⚠️ **注意**: 実行後、`results/` フォルダにスクリーンショットを配置してください。

| 機能 | スクリーンショット |
|------|-------------------|
| マルチオブジェクトトラッキング | `results/tracking_demo.png` |
| 軌跡描画 | `results/trails_demo.png` |
| 日本語ラベル + 人数カウント | `results/japanese_label_demo.png` |
